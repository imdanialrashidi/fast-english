...
Use the Playwright MCP browser and the repository's existing performance/build tools.
...
`/bootstrap` to record a confirmed project budget. A missing field/RUM
