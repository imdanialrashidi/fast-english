// admin/src/features/payments/components/RejectRequestDialog.tsx
      ...
      <DialogContent>
        <Stack sx={{ gap: 2, mt: 1 }}>
          <Alert severity="warning" data-testid="reject-student-warning">
            متن «دلیل رد» به دانشجو نمایش داده می‌شود. یادداشت داخلی فقط برای مدیریت است.
          </Alert>
          ...
          >
            <Stack sx={{ flexDirection: 'row', alignItems: 'center', gap: 1, mb: 1 }}>
              ...
              />
              <Typography variant="caption" color="text.secondary">
                فقط برای مدیریت قابل مشاهده است — در هیچ رخداد دانشجو نمایش داده نمی‌شود.
              </Typography>
            </Stack>
            <TextField
