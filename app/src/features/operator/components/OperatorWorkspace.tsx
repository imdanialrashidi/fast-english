// app/src/features/operator/components/OperatorWorkspace.tsx
// The operator operations workspace. One component renders both routes
// (`/operator` and `/operator/payment-requests/:id`), so the queue pane
...
export function OperatorWorkspace() {
  ...
  const openRequest = useCallback(
    (id: string) => {
      ...
      navigate(`/operator/payment-requests/${id}${location.search}`);
    },
