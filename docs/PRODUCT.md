...
- Tokens (initial): midnight `#0B1220`, primary `#2563EB`, violet `#7C3AED`, surface `#F8FAFC`, text `#0F172A`, success `#059669`, warning `#D97706`, error `#DC2626`. CEFR colors via named tokens with accessible pairs. No raw colors scattered in components.
