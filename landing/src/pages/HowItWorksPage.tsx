...
const steps = [
  ...
  },
  {
    ...
    desc: 'طرح ماهانه (۳۰ روز)، ۹۰ روزه یا ۳۶۵ روزه را انتخاب می‌کنید و مبلغ را کارت‌به‌کارت منتقل می‌کنید. سپس یک تصویر از رسید انتقال (JPEG، PNG یا WebP تا حداکثر ۵ مگابایت) بارگذاری می‌کنید. هیچ پرداخت آنلاین خودکاری وجود ندارد.',
  },
  {
