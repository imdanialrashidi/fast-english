    ...
    <section id="levels" aria-labelledby="levels-title" className="py-12 sm:py-20">
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <p className="mt-6 text-xs text-brand-muted max-w-3xl">
          سطوح بر پایهٔ چارچوب مرجع مشترک اروپایی (CEFR) هستند. فست انگلیش پادکست هیچ گواهی یا مدرک
          رسمی CEFR صادر نمی‌کند و روانی یا نتیجهٔ مشخصی را تضمین نمی‌کند؛ سطح پیشنهادی نیز فقط یک
          پیشنهاد است.
        </p>
      </div>
    </section>
