      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        >
          ...
          <div className="mt-6 grid sm:grid-cols-2 gap-3 sm:gap-4">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5">
              <span className="block text-xs font-semibold text-white/60 mb-2">iPhone / iPad</span>
              <p className="text-sm text-white/85 leading-relaxed">
                نصب وب‌اپ از سافاری روی صفحهٔ اصلی؛ بدون نسخهٔ فروشگاه اپل.
              </p>
              <a
                href="/install#ios"
                className="mt-3 inline-flex items-center justify-center rounded-xl bg-white/10 px-4 py-2 text-sm font-semibold text-white hover:bg-white/20 min-h-11"
              >
                نصب روی iPhone / iPad
              </a>
            </div>
