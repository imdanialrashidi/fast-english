...
# Run all 18 real-PocketBase smoke suites concurrently for the CI backend
...
SUITES=(
  ...
  "restore-proof|scripts/restore-proof.sh|scripts/restore-proof.mjs|PB_RESTORE_PROOF_PORT"
)
